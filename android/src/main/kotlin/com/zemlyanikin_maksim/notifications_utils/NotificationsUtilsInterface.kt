...
data class NotificationId (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): NotificationId {
      ...
      val androidTag = list[2] as String?
      return NotificationId(androidId, iosId, androidTag)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
...
interface NotificationsUtils {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: NotificationsUtils?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.notifications_utils.NotificationsUtils.getDeliveredNotifications", codec)
        if (api != null) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.notifications_utils.NotificationsUtils.removeDeliveredNotifications", codec)
        if (api != null) {
